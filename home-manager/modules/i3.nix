    ...
    config =
      ...
      in
      {
        ...
        window.commands = [
            ...
            { criteria = { class = "yakuake"; }; command = "floating enable"; }
        ...
        workspaceOutputAssign = [
            ...
            { output = "HDMI-1"; workspace = "4"; }
            { output = "HDMI-1"; workspace = "5"; }
            { output = "HDMI-1"; workspace = "6"; }
        ...
        keybindings = pkgs.lib.mkOptionDefault ({
 	    ...
 	    # --- Focus ---
            ...
            "${mod}+Shift+c" = "reload";
            "${mod}+Shift+r" = "restart";
            "${mod}+Shift+e" = "exec \"${pkgs.i3-gaps}/bin/i3-nagbar -t warning -m 'You pressed the exit shortcut. Do you really want to exit i3? This will end your X session.' -B 'Yes, exit i3' 'i3-msg exit'\"";
