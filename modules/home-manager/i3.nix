...
let
  ...
  # rofi vars
  rofi-themes = pkgs.callPackage ../../packages/rofi-plugins.nix { };
in
{
  services.picom.enable = true;
  # Define i3 settings under the xsession pathi
  ...
  programs.rofi = {
    ...
    # use themes from https://github.com/adi1090x/rofi
    theme = "${rofi-themes}/share/launchers/type-2/style-5.rasi";
  };
    ...
    config = {
      ...
      window.commands = [
...

        {
          ...
          command = "floating enable, border none, focus"; # Makes it float, no border, AND gives it focus
        }
      ];
      #noFocus = [
